...
sed "s/devices: .*/devices: \"$interface\"/; s/K3S-HOST/$nodeip/g; s/VTEP-ENDPOINT/$selfip/; s%VTEP-CIDR%$subnet%; s/VTEP-MAC/$mac/;" cilium-bigip.yaml > cilium-bigip-$nodeip.yaml
